...
function BookingCard() {
  return (
    <div className='flex justify-around items-center gap-x-4 text-[6px] lg:text-base lg:px-12 lg:pt-2 font-bold bg-white rounded-lg w-[370px] max-w-[468px] lg:max-w-[1200px] lg:w-[1200px] h-[100px] lg:h-[150px] lg:m-auto mt-[360px] lg:mt-[550px] text-[#345E40] '>
        <div>
