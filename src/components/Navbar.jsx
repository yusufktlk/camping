...
function Navbar() {
  return (
    <div className='lg:flex lg:justify-between lg:mx-24 mt-4 text-[12px] lg:text-base items-center'>
       <img src='navbarlogo.png' className='w-24 lg:w-32 lg:m-0 mb-2 lg:mb-0 ml-36 lg:ml-0' />
        <div className='flex gap-x-4 lg:gap-x-12 items-center text-white font-bold ml-4 lg:ml-0'>
            ...
            <Link to="booking" spy={true} smooth={true} offset={50} duration={1000} className='font-bold border-2 border-white rounded-lg w-20 lg:w-32 p-2  text-center center hover:scale-110 duration-500 cursor-pointer'>BOOK</Link>
        </div>
    </div>
  )
}
