  ...
  return (
    <div className='lg:flex lg:gap-x-44 mt-24 lg:mt-28 lg:mx-32 mb-32' id='activity'>
        <div>
            ...
            <p className='text-2xl lg:text-5xl font-bold ml-4 lg:ml-0 w-[320px] lg:w-[550px] mt-4'>Camp Will Be For You What You Want It To Be.</p>
            <div className='relative ml-2 lg:ml-0'>
                <img src='activitybg.png' className='w-[350px] lg:w-[550px] mt-12 lg:mt-40' />
                <img src='activity.png' className='w-[250px] lg:w-[400px] absolute top-0 left-14 lg:left-20' />
            </div>
        </div>
        <div className='flex gap-x-8 lg:gap-x-20'>
            <div className='flex flex-col gap-y-12 lg:gap-y-32 ml-3 lg:ml-0 mt-12 lg:mt-0'>
                <div className='flex flex-col gap-y-4'>
                    ...
                    <p className='w-[160px] lg:w-[250px] tracking-wide'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde, aperiam officia incidunt voluptate voluptates cumque.</p>
                </div>
                <div className='flex flex-col gap-y-4'>
